...
class load_table extends dts_table
{
	...
	function get_load_edit_2()
	{
		...
		if($auth_edit)
		{
			$c .= "<a href='#' onclick=\"javascript:popUp('http://".HTTP_ROOT."/?page=$this->page&action=$this->edit_str&module=$this->money_str&load_id=$this->load_id&".SMALL_VIEW."',0,925,250)\">Money</a>";
		}else{
			$c .= 'Money';
		}
