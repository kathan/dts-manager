...
class load_table extends dts_table
{
	...
	function get_search_results()
	{
		...
		return $t->fetch('/home/dts2828/www/dts/templates/load_search_result.tpl');
	}
	...
	function get_search_results_old()
	{
		...
		return '<!-- start search result -->'.$c.'<!-- end search result -->';
	}
	...
	function get_search_edit_old()
	{
		...
		$f->create_text_input('load_type');
		$f->create_text_input('order_number');
		$f->create_text_input('bol');
		
		return '<!-- start get search edit-->'.$this->_render_edit().'<!-- end get search edit-->';
	}
	...
	function get_search_edit()
	{
		...
		return $t->fetch('/home/dts2828/www/dts/templates/load_search_form.tpl');
	}
	...
	function get_money_module()
	{
		...
		$t->assign('wcp', $wcp);
		$t->assign('dtsp', $dtsp);
		return $t->fetch('/home/dts2828/www/dts/templates/money_load.tpl');
	}
		...
		function get_loads($date, $type)
	{
		...
		return $t->fetch('/home/dts2828/www/dts/templates/load_list.tpl');
	}
