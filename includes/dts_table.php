...
class dts_table extends table{
	...
	var $update = 'update';
	var $portal ='portal';
	var $account_status_list = ['Not Active' => 'Not Active', 'Active' => 'Active', 'Accounting Hold' => 'Accounting Hold'];
	public static $load_type = [''=>'', 'TL'=>'TL', 'LTL'=>'LTL', 'RAIL'=>'RAIL', 'OCEAN'=>'OCEAN', 'REFRIGERATED'=>'REFRIGERATED','PARTIAL'=>'PARTIAL'];
	var $trailer_type_list = ['Van' => 'Van', 'Refrig' => 'Refrig', 'Flatbed' => 'Flatbed'];
	var $rating_list = ['Standard' => 'Standard', 'Expedited' => 'Expedited'];
	...
	var $breadcrumb;
	var $warehouse_types = ['PICK'=>'PICK', 'DEST'=>'DEST'];
	var $page = 'page';
	var $tab_menu;
	var $prefix;
